...
export const AppBar = (props: any) => {
    ...
    return (
        <div className="flex justify-between shadow-md items-center bg p-3 mb-7">
            <div>Employees</div>

            <button type="button" onClick={() => setIsOpen(true)} className="text-white hover:text-white border bg-blue-700 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2">Add Employee</button>
